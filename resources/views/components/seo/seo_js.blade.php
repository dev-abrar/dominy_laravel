    ...
    $(document).ready(function () {
        ...
        $('.add_seo').click(function (e) {
            ...
            if (slug.length === 0) {
                ...
                toastify().error('Kewwords is required!');
            } else if (published_time.length === 0) {
                toastify().error('Publish Time is required!');
            } else if (modified_time.length === 0) {
                toastify().error('Modified Time is required!');
            } else if (author.length === 0) {
                toastify().error('Author is required!');
            } else if (canonical.length === 0) {
                toastify().error('Canonical is required!');
            } else if (og_locale.length === 0) {
                toastify().error('Og Locale is required!');
            } else if (og_url.length === 0) {
                toastify().error('Og URL is required!');
            } else if (og_type.length === 0) {
                toastify().error('Og Type is required!');
            } else if (twitter_card.length === 0) {
                toastify().error('Twitter Card is required!');
            } else if (twitter_site.length === 0) {
                toastify().error('Twitter Site is required!');
            } else if (twitter_label.length === 0) {
                toastify().error('Twitter Label is required!');
            } else if (twitter_data.length === 0) {
                toastify().error('Twitter Data is required!');
            } else if (!img) {
